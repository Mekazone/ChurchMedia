...
class LettersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.letters', compact('results', 'letter'));
    }
    ...
    {
        return view('admin.letterCreate');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->topAttachments)
        {
            ...
            foreach($request->topAttachments as $key => $val)
            {
                ...
                $destinationPath = storage_path('app/public/letters');
                if (!file_exists($destinationPath)) {
                    @mkdir($destinationPath);
                }
                $destinationPath = storage_path('app/public/letters/'.$date);
                if (!file_exists($destinationPath)) {
                    @mkdir($destinationPath);
                }
                ...
                $imagePath = 'public/letters/'.$date.'/'.$fileName;
                    
                    $attachment = LettersAttachment::create([
                        'filePosition' => 'top',
    ...
    public function show($date, $slug)
    {
        ...
        return view('admin.letterView', compact('result', 'letter', 'attachments'));
    }
    ...
    {
        $results = Letter::where('id', $id)->first();
        $day = date('d', $results->date);
        $month = date('m', $results->date);
        $year = date('Y', $results->date);
        $attachments = LettersAttachment::where('postId', $id)->get();
        return view('admin.letterEdit', compact('results', 'attachments', 'id', 'day', 'month', 'year'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $images = LettersAttachment::where('postId', $id)->get();        
        ...
        $images = LettersAttachment::where('postId', $id);
        $images->delete();
        ...
        //update db
        $update = Letter::where('id', $id)->first();
        $update->date = $date;
        ...
        return redirect('/admin/letters')->with('success', 'Edit successful');
    }
