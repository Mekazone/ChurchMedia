...
class CreateOpinionsAttachmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('opinions_attachments', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
    ...
    {
        Schema::dropIfExists('opinions_attachments');
    }
}
